          ...
          <div class="xl:px-24">
            ...
            <div class="mt-16 lg:flex justify-between border-b border-gray-200 pb-16 mb-4">
              ...
              <div>
                <div class="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                  <div class="md:w-64">
                    <label class="text-sm leading-none text-gray-800" id="">
                      Vehicle Type
                    </label>
                    <input
                      type="name"
                ...
                <div class="md:flex items-center lg:ml-24 mt-8">
                  ...
                  <div class="md:w-64 md:ml-12 md:mt-0 mt-4">
                    <div class="md:w-64">
                      <label class="text-sm leading-none text-gray-800" id="r">
                        Booking Type
                      </label>

                      <select className="select select-bordered mt-3 w-full max-w-xs">
                        <option>Washing</option>
                        <option>Serviceing</option>
                      </select>
                    </div>
                  </div>
                </div>
                <button className="btn btn-primary mt-10 ml-24">
                  Make Booking
                </button>
              </div>
            </div>
