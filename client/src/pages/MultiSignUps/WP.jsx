...
export const WP = () => {
  ...
  const onSubmit = (data) => {
    ...
    registerUser(data.mail, data.pass)
      .then((res) => {
        console.log(res);
        saveToServer(data.mail, "wp", "adduser");
        saveToServer(undefined, undefined, "addwpinfo", data);
        navigate("/login");
      })
      .catch((error) => {
        setError(error);
      ...
      <div className="hero min-h-screen bg-base-200 ">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 swing-in-top-fwd">
            <h1 className="text-center font-bold text-3xl mt-3">W/P Signup</h1>
            <form onSubmit={handleSubmit(onSubmit)} className="card-body w-96">
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  className="input input-bordered"
                  {...register("pre_add", { required: true })}
                />
              </div>
              <div className="form-control">
                <label className="label">
                ...
                <input
                  ...
                  className="input input-bordered"
                  {...register("par_add", { required: true })}
                />
              </div>
              <div className="form-control">
                <label className="label">
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  className="input input-bordered"
                  {...register("srv_area", { required: true })}
                />
              </div>
              <label className="label">
              ...
              <select
                ...
                {...register("v_service", { required: true })}
              >
                <option>Bike</option>
                <option>Car</option>
                <option>Bus</option>
              ...
              <select
                {...register("inst_type", { required: true })}
                className="select select-info w-full max-w-xs"
              >
