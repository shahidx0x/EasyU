...
export const Login = () => {
  ...
  const { login, auth, gProvider } = useAuth();
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <>
      <div className="bg-indigo-50 rounded-2xl">
    ...
    //         quo quisquam natus quod unde quas, alias id harum nulla, similique
    //         ipsam aliquam est et rem ullam dolore. Maiores, ipsa?
    //       </p>
    //     </div>
